...
import { FaArrowLeft, FaPercentage } from 'react-icons/fa';
...
function Step3Report({ report }) {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-200 sm:px-6 lg:px-10 py-8">
            ...
            <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                py-3 px-5 rounded-2xl shadow-md text-nowrap transition-all duration-300 font-semibold 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
                ...
                <div className="space-y-6">
                    ...
                    >
                        ...
                        <div className="w-16 h-16 sm:h-24 mx-auto ">
                            <CircularProgressbar
                                value={percentage}
                                text={`${score}/10`}
                                styles={buildStyles({
