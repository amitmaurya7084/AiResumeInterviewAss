...
const Testimonial = () => {
  ...
  return (
    <>
      <div id="testimonial" className="flex flex-col items-center my-10 scroll-mt-12 mt-28">
        <div className="flex items-center gap-3 text-sm text-green-800 bg-green-400/10 rounded-full px-6 py-1.5 mt-28">
